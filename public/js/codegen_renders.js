...
function RenderCharts(chart_IN, symbol_IN, final_price_IN, price_change_IN)
{
...
function RenderPortfolioCharts(chart_IN, symbol_IN, final_price_IN, price_change_IN, analytics_IN = true)
{
  if(price_change_IN < 0) changeColor = "text-danger"
  else changeColor = "text-success"
  price_change_IN = "$"+Math.round(price_change_IN*100)/100;
